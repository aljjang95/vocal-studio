...
def _make_analysis(**overrides) -> TensionAnalysis:
    defaults = {
        ...
        "register": RegisterTransition(transition_detected=False, f0_max_jump_hz=5.0,
...
class TestTensionScorer:
    ...
    def test_register_break_increases_score(self):
        score = calculate_tension_score(_make_analysis(
            register=RegisterTransition(transition_detected=True, f0_max_jump_hz=40.0,
    ...
    def test_score_clamped(self):
        score = calculate_tension_score(_make_analysis(
            ...
            register=RegisterTransition(transition_detected=True, f0_max_jump_hz=80.0,
